...
" not, ensure that the dataset meets these following requirements.", size=(60,6), text_color='black')],
        ...
        [Text("1. Ensure that you have 1 Blank sample which is named \"Blank_1.raw Peak area\". If you have more than one Blank samples, "
"please manually process the rest.", size=(60,4), text_color='black')],
...
layout3= [
            [Text('Blank Cutoff (ex. 10000)', size=(40, 1)), InputText()],
            [Text('Higher Retention Time Cutoff (ex. 8) ', size=(40, 1)), InputText()],
            [Text('Lower Retention Time Cutoff (ex. 2) ', size=(40, 1)), InputText()],
            [Text('Higher m/z Cutoff (ex. 850)', size=(40, 1)), InputText()],
            [Text('Lower m/z Cutoff (ex. 200)', size=(40, 1)), InputText()],
            [Text('RSD cutoff (ex. 0.40)', size=(40, 1)), InputText()],
            [Text('# of Technical Replicates per sample (ex. 4)', size=(40, 1)), InputText()],
            [Text('# of Biological Replicates per sample (ex. 4) ', size=(40, 1)), InputText()],
            [Submit()]
